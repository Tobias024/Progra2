...
public interface IHelper {
     ...
     * @return arreglo de todas las clases ancestro
     */
    IClazz[] getAncestors(IClazz clazz);

    /**
     * Obtiene todos los descendientes de una clase.
     * @param clazz la clase
     * @return arreglo de todas las clases descendiente
     */
    IClazz[] getDescendants(IClazz clazz);
}